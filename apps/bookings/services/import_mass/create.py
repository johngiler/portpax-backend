...
def _claim_lta_space_booking(
    *,
    ...
    from apps.bookings.services.booking.claim_lta_space import (
        ClaimLtaSpaceError,
        claim_lta_space_booking,
    )

    try:
        return claim_lta_space_booking(
    ...
    except ClaimLtaSpaceError as exc:
        raise BookingBatchCreateError(str(exc), exc.field) from exc
