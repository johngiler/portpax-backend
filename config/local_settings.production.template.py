"""
PRODUCTION environment (ITM) — copy to config/local_settings.py on api.itmgroup.mx

  cp config/local_settings.production.template.py config/local_settings.py
