#!/usr/bin/env bash
#
# Create Postgres user and database for PortPax from backend/.env
# Run as root or postgres on the server after setup.sh.
# Usage: from backend/ dir: ./scripts/init_db.sh
#
